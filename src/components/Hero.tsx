      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 grid lg:grid-cols-2 gap-16 items-center relative z-10">
        ...
        >
          ...
          <p className="text-base text-slate-600 mb-8 leading-relaxed font-sans font-normal max-w-xl">
            Бесплатно разрабатываем и внедряем (с переходом на подписку) передовые решения на базе искусственного интеллекта для дилерских центров. Оптимизируем продажи, автоматизируем работу с сервисом и улучшаем репутацию.
          </p>
