    ...
    <section className="py-28 lg:py-36 relative">
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        >
          ...
          <p className="text-lg text-slate-600 max-w-2xl font-sans font-light leading-relaxed">Прозрачный процесс, предсказуемые сроки и бесплатная пилотная разработка для вашего спокойствия.</p>
        </motion.div>
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-20">
          ...
          >
            <div>
              <p className="text-xs font-semibold text-slate-400 uppercase tracking-wider mb-2">Стоимость пилота</p>
              <p className="text-3xl font-bold font-display text-slate-900">0 ₽ — Бесплатно</p>
            </div>
            <p className="text-slate-500 text-sm mt-4 font-sans font-light">Мы бесплатно разрабатываем для автокомпаний AI-инструменты под их задачи — без оплаты и без обязательств на этапе пилота, далее для использования доступна подписка.</p>
          </motion.div>
